...
function Advanced() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main
        role="main"
        className="flex flex-col gap-4 px-5! py-4! md:px-10! lg:px-16! 3xl:gap-6">
        {/* TOPO */}
        ...
        {chartData ? (
          ...
          <BaseCard>
            ...
            <div className="p-8 min-h-28 text-(--text-800) flex items-center justify-center">
              {/* If still loading show loading text, otherwise it might be empty data */}
              <p>{isLoading ? "Carregando previsão..." : "Aguardando dados da previsão..."}</p>
            </div>
          </BaseCard>
        )}
